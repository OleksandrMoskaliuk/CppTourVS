...
void dct_core::DctCore::DrawInLoop( std::wstring Text, sf::Color TextColor, int TextSize , int xp, int yp) {
  std::wstring str = Text;
  sf::Text txt;

  txt.setFont(*fonts.GetRobotoSlabFont());
...
void dct_core::DctCore::MainLoop() {
  ...
  DrawInLoop( L"Nani", sf::Color::Green,16, 10, 30);
